...
type ChartTooltipContentProps = React.HTMLAttributes<HTMLDivElement> & {
  active?: boolean
  payload?: Array<Record<string, unknown> & { value?: unknown; name?: string; dataKey?: string; color?: string; fill?: string; payload?: Record<string, unknown> }>
...
function getPayloadConfigFromPayload(
  ...
  const c = config as Record<string, ChartConfig[string]>
  return configLabelKey in c ? c[configLabelKey] : c[key]
}
